...
public class Settings {
	...
	/**
	 * Extra configuration information for the SQL connection string
	 */
	private String dbExtraSettings;
	...
	/**
	 * Gets the extra settings for the database.
	 * 
	 * @return the extra settings
	 */
	public String getdbExtraSettings() {
		return dbExtraSettings;
	}
	...
	void readSettings() {
		...
		dbExtraSettings = config.getString("database.extrasettings");
	}
